...
const onSignInSuccess = function (responseData) {
  ...
  // Enables create and view buttons
...
const onViewAllSuccess = function (smoothieData) {
  $('.show-smoothies').html(``)
  $('.show-smoothies').append(smoothieHandlebar({smoothies: smoothieData.smoothies}))
...
const onViewOneSuccess = function (smoothyData) {
  ...
  $('.show-smoothies').html(``)
  $('.show-smoothies').append(smoothieHandlebar({smoothies: smoothyData}))
  console.log($('.show-smoothies'))
}
